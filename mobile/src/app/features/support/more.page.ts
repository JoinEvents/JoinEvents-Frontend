      ...
      <div class="je-section">
        <div class="je-card ident">
          ...
          <div class="ident__body">
            ...
            <span class="je-pill je-pill--neutral">Support agent</span>
          </div>
        </div>

        <ion-list class="je-card je-card--flush menu" [inset]="false">
          <ion-item routerLink="/support/reviews" [detail]="true" lines="full">
            <ion-icon name="chatbox-ellipses-outline" slot="start" color="medium" />
            <ion-label>Review moderation</ion-label>
          </ion-item>
          <ion-item routerLink="/support/directory" [detail]="true" lines="full">
            <ion-icon name="people-outline" slot="start" color="medium" />
            <ion-label>Customer &amp; vendor directory</ion-label>
          </ion-item>
          <ion-item routerLink="/support/notifications" [detail]="true" lines="full">
          ...
          <ion-item routerLink="/support/settings" [detail]="true" lines="none">
